...
void makeMarks(int *place, SDL_Surface *imageX, SDL_Surface *imageO, SDL_Surface *screen) {
	if(place[0] == 1)
		drawImg(imgX, screen, 120, 43);
	else if(place[0] == 2)
		drawaImg(imgO, screen, 120, 43);
	
	if(place[1] == 1)
		drawImg(imgX, screen, 273, 43);
	else if(place[1] == 2)
		drawaImg(imgO, screen, 273, 43);
	
	if(place[2] == 1)
		drawImg(imgX, screen, 423, 43);
	else if(place[2] == 2)
		drawaImg(imgO, screen, 423, 43);
	
	if(place[3] == 1)
		drawImg(imgX, screen, 120, 188);
	else if(place[3] == 2)
		drawaImg(imgO, screen, 120, 188);
	
	if(place[4] == 1)
		drawImg(imgX, screen, 273, 188);
	else if(place[4] == 2)
		drawaImg(imgO, screen, 273, 188);
	
	if(place[5] == 1)
		drawImg(imgX, screen, 423, 188);
	else if(place[5] == 2)
		drawaImg(imgO, screen, 423, 188);
	
	if(place[6] == 1)
		drawImg(imgX, screen, 120, 338);
	else if(place[6] == 2)
		drawaImg(imgO, screen, 120, 338);
	
	if(place[7] == 1)
		drawImg(imgX, screen, 273, 338);
	else if(place[7] == 2)
		drawaImg(imgO, screen, 273, 338);
	
	if(place[0] == 1)
		drawImg(imgX, screen, 423, 338);
	else if(place[0] == 2)
		drawaImg(imgO, screen, 423, 338);
}
